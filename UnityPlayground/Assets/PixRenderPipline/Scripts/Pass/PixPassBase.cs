...
namespace PixRenderPipline
{
    ...
    public class PixPassBase
    {
        ...
        public static readonly int DepthTex = Shader.PropertyToID("_PixDepthTex");
        public static readonly int NormalTex = Shader.PropertyToID("_PixNormalTex");
        public static readonly int OpaqueRT = Shader.PropertyToID("_PixOpaqueTex");
        public static readonly int MotionVectorRT = Shader.PropertyToID("_PixMotionVectorTex");
